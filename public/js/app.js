...
__webpack_require__(/*! ../libs/jquery-toast-plugin/jquery.toast.min.js */ "./resources/libs/jquery-toast-plugin/jquery.toast.min.js"); //require('../libs/sweetalert2/sweetalert2.min.js');


__webpack_require__(/*! ../libs/parsleyjs/parsley.min.js */ "./resources/libs/parsleyjs/parsley.min.js"); //require('./jquery.core.js');
...
!function ($) {
  ...
  */
  ...
  App.prototype.init = function () {
    ...
    this.initLayout();
    this.initMenu();
    this.initToast(); // handle responsiveness when reload
